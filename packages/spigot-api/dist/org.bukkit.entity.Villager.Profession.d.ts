    ...
    namespace bukkit {
        namespace entity {
            namespace Villager {
                 ...
                 */
                // @ts-ignore
                class Profession extends java.lang.Enum<org.bukkit.entity.Villager.Profession> implements org.bukkit.Keyed {
                    // @ts-ignore
                    readonly NONE: org.bukkit.entity.Villager.Profession
                    /**
                     * Armorer profession. Wears a black apron. Armorers primarily trade for
                     * iron armor, chainmail armor, and sometimes diamond armor.
                     */
                    // @ts-ignore
                    readonly ARMORER: org.bukkit.entity.Villager.Profession
                    /**
                     * Butcher profession. Wears a white apron. Butchers primarily trade for
                     * raw and cooked food.
                     */
                    // @ts-ignore
                    readonly BUTCHER: org.bukkit.entity.Villager.Profession
                    /**
                     * Cartographer profession. Wears a white robe. Cartographers primarily
                     * trade for explorer maps and some paper.
                     */
                    // @ts-ignore
                    readonly CARTOGRAPHER: org.bukkit.entity.Villager.Profession
                    /**
                     ...
                     */
                    // @ts-ignore
                    readonly LEATHERWORKER: org.bukkit.entity.Villager.Profession
                    /**
                     * Librarian profession. Wears a white robe. Librarians primarily trade
                     * for paper, books, and enchanted books.
                     */
                    // @ts-ignore
                    readonly LIBRARIAN: org.bukkit.entity.Villager.Profession
                    /**
                     * Mason profession.
                     */
                    // @ts-ignore
                    readonly MASON: org.bukkit.entity.Villager.Profession
                    /**
                     ...
                     */
                    // @ts-ignore
                    readonly NITWIT: org.bukkit.entity.Villager.Profession
                    /**
                     * Sheperd profession. Wears a brown robe. Shepherds primarily trade for
                     * wool items, and shears.
                     */
                    // @ts-ignore
                    readonly SHEPHERD: org.bukkit.entity.Villager.Profession
                    /**
                     * Toolsmith profession. Wears a black apron. Tool smiths primarily
                     * trade for iron and diamond tools.
                     */
                    // @ts-ignore
                    readonly TOOLSMITH: org.bukkit.entity.Villager.Profession
                    /**
                     * Weaponsmith profession. Wears a black apron. Weapon smiths primarily
                     * trade for iron and diamond weapons, sometimes enchanted.
                     */
                    // @ts-ignore
                    readonly WEAPONSMITH: org.bukkit.entity.Villager.Profession
                    // @ts-ignore
                    values(): org.bukkit.entity.Villager.Profession[]
                    // @ts-ignore
                    valueOf(name: java.lang.String | string): org.bukkit.entity.Villager.Profession
                    // @ts-ignore
