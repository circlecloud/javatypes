        ...
        namespace event {
            namespace block {
                ...
                class BlockMultiPlaceEvent extends org.bukkit.event.block.BlockPlaceEvent {
                    // @ts-ignore
                    constructor(states: Array<org.bukkit.block.BlockState>, clicked: org.bukkit.block.Block, itemInHand: org.bukkit.inventory.ItemStack, thePlayer: org.bukkit.entity.Player, canBuild: boolean)
                    /**
                     ...
                     */
                    // @ts-ignore
                    getReplacedBlockStates(): java.util.List<org.bukkit.block.BlockState>
                }
            }
        }
    }
