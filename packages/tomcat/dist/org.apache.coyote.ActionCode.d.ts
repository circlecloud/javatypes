    ...
    namespace apache {
        namespace coyote {
            ...
            class ActionCode extends java.lang.Enum<org.apache.coyote.ActionCode> {
                // @ts-ignore
                readonly ACK: org.apache.coyote.ActionCode
                // @ts-ignore
                readonly CLOSE: org.apache.coyote.ActionCode
                // @ts-ignore
                readonly COMMIT: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly CLOSE_NOW: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly IS_IO_ALLOWED: org.apache.coyote.ActionCode
                /**
                 * Hook called if swallowing request input should be disabled.
                 * Example: Cancel a large file upload.
                 */
                // @ts-ignore
                readonly DISABLE_SWALLOW_INPUT: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - extract the remote host name and address.
                 */
                // @ts-ignore
                readonly REQ_HOST_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - extract the remote host address.
                 */
                // @ts-ignore
                readonly REQ_HOST_ADDR_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - extract the SSL-related attributes
                 * including the client certificate if present.
                 */
                // @ts-ignore
                readonly REQ_SSL_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Force a TLS re-handshake and make the resulting client certificate (if
                 * any) available as a request attribute.
                 */
                // @ts-ignore
                readonly REQ_SSL_CERTIFICATE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - socket remote port.
                 */
                // @ts-ignore
                readonly REQ_REMOTEPORT_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - socket local port.
                 */
                // @ts-ignore
                readonly REQ_LOCALPORT_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - local address.
                 */
                // @ts-ignore
                readonly REQ_LOCAL_ADDR_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for lazy evaluation - local address.
                 */
                // @ts-ignore
                readonly REQ_LOCAL_NAME_ATTRIBUTE: org.apache.coyote.ActionCode
                /**
                 * Callback for setting FORM auth body replay
                 */
                // @ts-ignore
                readonly REQ_SET_BODY_REPLAY: org.apache.coyote.ActionCode
                /**
                 * Callback for getting the amount of available bytes.
                 */
                // @ts-ignore
                readonly AVAILABLE: org.apache.coyote.ActionCode
                /**
                 * Callback for an async request.
                 */
                // @ts-ignore
                readonly ASYNC_START: org.apache.coyote.ActionCode
                /**
                 * Callback for an async call to
                 * {@link javax.servlet.AsyncContext#dispatch()}.
                 */
                // @ts-ignore
                readonly ASYNC_DISPATCH: org.apache.coyote.ActionCode
                /**
                 * Callback to indicate the the actual dispatch has started and that the
                 * async state needs change.
                 */
                // @ts-ignore
                readonly ASYNC_DISPATCHED: org.apache.coyote.ActionCode
                /**
                 * Callback for an async call to
                 * {@link javax.servlet.AsyncContext#start(Runnable)}.
                 */
                // @ts-ignore
                readonly ASYNC_RUN: org.apache.coyote.ActionCode
                /**
                 * Callback for an async call to
                 * {@link javax.servlet.AsyncContext#complete()}.
                 */
                // @ts-ignore
                readonly ASYNC_COMPLETE: org.apache.coyote.ActionCode
                /**
                 * Callback to trigger the processing of an async timeout.
                 */
                // @ts-ignore
                readonly ASYNC_TIMEOUT: org.apache.coyote.ActionCode
                /**
                 * Callback to trigger the error processing.
                 */
                // @ts-ignore
                readonly ASYNC_ERROR: org.apache.coyote.ActionCode
                /**
                 * Callback for an async call to
                 * {@link javax.servlet.AsyncContext#setTimeout(long)}
                 */
                // @ts-ignore
                readonly ASYNC_SETTIMEOUT: org.apache.coyote.ActionCode
                /**
                 * Callback to determine if async processing is in progress.
                 */
                // @ts-ignore
                readonly ASYNC_IS_ASYNC: org.apache.coyote.ActionCode
                /**
                 * Callback to determine if async dispatch is in progress.
                 */
                // @ts-ignore
                readonly ASYNC_IS_STARTED: org.apache.coyote.ActionCode
                /**
                 * Call back to determine if async complete is in progress.
                 */
                // @ts-ignore
                readonly ASYNC_IS_COMPLETING: org.apache.coyote.ActionCode
                /**
                 * Callback to determine if async dispatch is in progress.
                 */
                // @ts-ignore
                readonly ASYNC_IS_DISPATCHING: org.apache.coyote.ActionCode
                /**
                 * Callback to determine if async is timing out.
                 */
                // @ts-ignore
                readonly ASYNC_IS_TIMINGOUT: org.apache.coyote.ActionCode
                /**
                 * Callback to determine if async is in error.
                 */
                // @ts-ignore
                readonly ASYNC_IS_ERROR: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly ASYNC_POST_PROCESS: org.apache.coyote.ActionCode
                /**
                 * Callback to trigger the HTTP upgrade process.
                 */
                // @ts-ignore
                readonly UPGRADE: org.apache.coyote.ActionCode
                /**
                 * Indicator that Servlet is interested in being
                 * notified when data is available to be read.
                 */
                // @ts-ignore
                readonly NB_READ_INTEREST: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly DISPATCH_EXECUTE: org.apache.coyote.ActionCode
                /**
                 * Is server push supported and allowed for the current request?
                 */
                // @ts-ignore
                readonly IS_PUSH_SUPPORTED: org.apache.coyote.ActionCode
                /**
                 * Push a request on behalf of the client of the current request.
                 */
                // @ts-ignore
                readonly PUSH_REQUEST: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly IS_TRAILER_FIELDS_READY: org.apache.coyote.ActionCode
                /**
                 ...
                 */
                // @ts-ignore
                readonly IS_TRAILER_FIELDS_SUPPORTED: org.apache.coyote.ActionCode
                // @ts-ignore
                values(): org.apache.coyote.ActionCode[]
                // @ts-ignore
                valueOf(name: java.lang.String | string): org.apache.coyote.ActionCode
            }
        }
    }
}
