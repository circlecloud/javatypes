        ...
        namespace catalina {
            namespace valves {
                namespace ExtendedAccessLogValve {
                    // @ts-ignore
                    class RequestAttributeElement extends java.lang.Object implements org.apache.catalina.valves.AbstractAccessLogValve.AccessLogElement {
                        // @ts-ignore
                        constructor(attribute: java.lang.String | string)
                        // @ts-ignore
