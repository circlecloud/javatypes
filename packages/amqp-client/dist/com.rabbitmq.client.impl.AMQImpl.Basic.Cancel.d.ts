        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Basic {
                        // @ts-ignore
                        class Cancel extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Basic.Cancel {
                            // @ts-ignore
                            constructor(consumerTag: java.lang.String | string, nowait: boolean)
                            // @ts-ignore
