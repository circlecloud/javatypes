        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Queue {
                        // @ts-ignore
                        class Delete extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Queue.Delete {
                            // @ts-ignore
                            constructor(ticket: number /*int*/, queue: java.lang.String | string, ifUnused: boolean, ifEmpty: boolean, nowait: boolean)
                            // @ts-ignore
