            ...
            namespace impl {
                namespace AMQImpl {
                    namespace Connection {
                        // @ts-ignore
                        class SecureOk extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Connection.SecureOk {
                            // @ts-ignore
                            constructor(response: com.rabbitmq.client.LongString)
                            // @ts-ignore
