        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Basic {
                        // @ts-ignore
                        class GetEmpty extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Basic.GetEmpty {
                            // @ts-ignore
                            constructor(clusterId: java.lang.String | string)
                            // @ts-ignore
