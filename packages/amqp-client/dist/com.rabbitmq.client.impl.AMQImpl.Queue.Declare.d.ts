        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Queue {
                        // @ts-ignore
                        class Declare extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Queue.Declare {
                            // @ts-ignore
                            constructor(ticket: number /*int*/, queue: java.lang.String | string, passive: boolean, durable: boolean, exclusive: boolean, autoDelete: boolean, nowait: boolean, arguments: java.util.Map<java.lang.String | string, java.lang.Object | any>)
                            // @ts-ignore
