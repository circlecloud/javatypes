        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Queue {
                        // @ts-ignore
                        class DeclareOk extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Queue.DeclareOk {
                            // @ts-ignore
                            constructor(queue: java.lang.String | string, messageCount: number /*int*/, consumerCount: number /*int*/)
                            // @ts-ignore
                            ...
                            // @ts-ignore
                            public getConsumerCount(): number /*int*/
                            // @ts-ignore
