        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Queue {
                        // @ts-ignore
                        class Unbind extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Queue.Unbind {
                            // @ts-ignore
                            constructor(ticket: number /*int*/, queue: java.lang.String | string, exchange: java.lang.String | string, routingKey: java.lang.String | string, arguments: java.util.Map<java.lang.String | string, java.lang.Object | any>)
                            // @ts-ignore
