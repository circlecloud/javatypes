        ...
        namespace client {
            namespace impl {
                namespace AMQImpl {
                    namespace Basic {
                        // @ts-ignore
                        class Reject extends com.rabbitmq.client.impl.Method implements com.rabbitmq.client.AMQP.Basic.Reject {
                            // @ts-ignore
                            constructor(deliveryTag: number /*long*/, requeue: boolean)
                            // @ts-ignore
