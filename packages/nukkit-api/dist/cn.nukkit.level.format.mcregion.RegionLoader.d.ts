            ...
            namespace format {
                namespace mcregion {
                    ...
                    class RegionLoader extends cn.nukkit.level.format.generic.BaseRegionLoader {
                        ...
                        // @ts-ignore
                        public readChunk(x: number /*int*/, z: number /*int*/): cn.nukkit.level.format.mcregion.Chunk
                        // @ts-ignore
                        unserializeChunk(data: number /*byte*/[]): cn.nukkit.level.format.mcregion.Chunk
                        // @ts-ignore
