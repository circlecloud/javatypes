        ...
        namespace event {
            namespace entity {
                ...
                class CreatureSpawnEvent extends cn.nukkit.event.Event implements cn.nukkit.event.Cancellable {
                    // @ts-ignore
                    constructor(networkId: number /*int*/, position: cn.nukkit.level.Position, nbt: cn.nukkit.nbt.tag.CompoundTag, reason: cn.nukkit.event.entity.CreatureSpawnEvent.SpawnReason)
                    // @ts-ignore
                    public static getHandlers(): cn.nukkit.event.HandlerList
                    // @ts-ignore
                    public getReason(): cn.nukkit.event.entity.CreatureSpawnEvent.SpawnReason
                    // @ts-ignore
                    public getEntityNetworkId(): number /*int*/
                    // @ts-ignore
