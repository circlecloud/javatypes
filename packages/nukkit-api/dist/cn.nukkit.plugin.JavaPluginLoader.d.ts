    ...
    namespace nukkit {
        namespace plugin {
            ...
            class JavaPluginLoader extends java.lang.Object implements cn.nukkit.plugin.PluginLoader {
                ...
                // @ts-ignore
                public loadPlugin(filename: java.lang.String | string): cn.nukkit.plugin.Plugin
                // @ts-ignore
                public getPluginDescription(file: java.io.File): cn.nukkit.plugin.PluginDescription
                // @ts-ignore
                public getPluginDescription(filename: java.lang.String | string): cn.nukkit.plugin.PluginDescription
                // @ts-ignore
