declare namespace cn {
    namespace nukkit {
        namespace item {
            namespace ItemFirework {
                // @ts-ignore
                class FireworkExplosion extends java.lang.Object {
                    // @ts-ignore
                    constructor()
                    // @ts-ignore
                    public getColors(): Array<cn.nukkit.utils.DyeColor>
                    // @ts-ignore
                    public getFades(): Array<cn.nukkit.utils.DyeColor>
                    // @ts-ignore
