    ...
    namespace nukkit {
        namespace plugin {
            ...
            class RegisteredListener extends java.lang.Object {
                // @ts-ignore
                constructor(listener: cn.nukkit.event.Listener, executor: cn.nukkit.plugin.EventExecutor, priority: cn.nukkit.event.EventPriority, plugin: cn.nukkit.plugin.Plugin, ignoreCancelled: boolean, timing: co.aikar.timings.Timing)
                // @ts-ignore
