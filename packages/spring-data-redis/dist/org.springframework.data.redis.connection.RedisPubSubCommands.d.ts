            ...
            namespace redis {
                namespace connection {
                    ...
                    interface RedisPubSubCommands {
                         ...
                         */
                        // @ts-ignore
                        getSubscription(): org.springframework.data.redis.connection.Subscription
                        /**
                         ...
                         */
                        // @ts-ignore
                        publish(channel: number /*byte*/[], message: number /*byte*/[]): number
                        /**
                         ...
                         */
                        // @ts-ignore
                        subscribe(listener: org.springframework.data.redis.connection.MessageListener, ...channels: number /*byte*/[][]): void
                        /**
                         ...
                         */
                        // @ts-ignore
                        pSubscribe(listener: org.springframework.data.redis.connection.MessageListener, ...patterns: number /*byte*/[][]): void
                    }
                }
            }
        }
