        ...
        namespace api {
            namespace util {
                ...
                class AABB extends java.lang.Object {
                     ...
                     */
                    // @ts-ignore
                    public contains(point: Vector3i): boolean
                    /**
                     * Checks if the bounding box contains a point.
                     * @param point The point to check
                     * @return Whether or not the box contains the point
                     ...
                     */
                    // @ts-ignore
                    public intersects(start: Vector3d, direction: Vector3d): java.util.Optional<org.spongepowered.api.util.Tuple<Vector3d, Vector3d>>
                    /**
                     ...
                     */
                    // @ts-ignore
                    public offset(offset: Vector3i): org.spongepowered.api.util.AABB
                    /**
                     * Offsets this bounding box by a given amount and returns a new box.
                     * @param offset The offset to apply
                     * @return The new offset box
                     */
                    // @ts-ignore
                    public offset(offset: Vector3d): org.spongepowered.api.util.AABB
                    /**
                     * Offsets this bounding box by a given amount and returns a new box.
                     ...
                     */
                    // @ts-ignore
                    public offset(x: number /*double*/, y: number /*double*/, z: number /*double*/): org.spongepowered.api.util.AABB
                    /**
                     ...
                     */
                    // @ts-ignore
                    public expand(amount: Vector3i): org.spongepowered.api.util.AABB
                    /**
                     * Expands this bounding box by a given amount in both directions and
                     * returns a new box. The expansion is applied half and half to the
                     * minimum and maximum corners.
                     ...
                     */
                    // @ts-ignore
                    public expand(amount: Vector3d): org.spongepowered.api.util.AABB
                    /**
                     * Expands this bounding box by a given amount in both directions and
                     * returns a new box. The expansion is applied half and half to the
                     * minimum and maximum corners.
                     ...
                     */
                    // @ts-ignore
                    public expand(x: number /*double*/, y: number /*double*/, z: number /*double*/): org.spongepowered.api.util.AABB
                    // @ts-ignore
