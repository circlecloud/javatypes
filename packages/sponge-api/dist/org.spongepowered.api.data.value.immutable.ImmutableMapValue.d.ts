                ...
                namespace value {
                    namespace immutable {
                        ...
                        interface ImmutableMapValue<K, V> extends org.spongepowered.api.data.value.immutable.ImmutableValue<java.util.Map<K, V>> {
                             ...
                             */
                            // @ts-ignore
                            withoutAll(predicate: java.util.function$.Predicate<java.util.Map.Entry<K, V>>): org.spongepowered.api.data.value.immutable.ImmutableMapValue<K, V>
                            /**
                            ...
                            values(): object
                            // @ts-ignore
                            transform(func: java.util.function$.Function<java.util.Map<K, V>, java.util.Map<K, V>>): org.spongepowered.api.data.value.immutable.ImmutableMapValue<K, V>
                            // @ts-ignore
