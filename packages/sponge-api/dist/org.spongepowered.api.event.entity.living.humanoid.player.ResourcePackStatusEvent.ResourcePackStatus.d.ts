                            ...
                            namespace player {
                                namespace ResourcePackStatusEvent {
                                    ...
                                    class ResourcePackStatus extends java.lang.Enum<org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus> {
                                         ...
                                         */
                                        // @ts-ignore
                                        public static readonly ACCEPTED: org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus
                                        /**
                                         * The client declined to download the pack.
                                         */
                                        // @ts-ignore
                                        public static readonly DECLINED: org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus
                                        /**
                                         ...
                                         */
                                        // @ts-ignore
                                        public static readonly FAILED: org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus
                                        /**
                                         ...
                                         */
                                        // @ts-ignore
                                        public static readonly SUCCESSFULLY_LOADED: org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus
                                        // @ts-ignore
                                        ...
                                        // @ts-ignore
                                        public static valueOf(name: java.lang.String | string): org.spongepowered.api.event.entity.living.humanoid.player.ResourcePackStatusEvent.ResourcePackStatus
                                        /**
                                         ...
                                         */
                                        // @ts-ignore
                                        public wasSuccessful(): java.util.Optional<java.lang.Boolean>
                                    }
                                }
                            }
                        }
