    ...
    namespace spongepowered {
        namespace api {
            ...
            class GameState extends java.lang.Enum<org.spongepowered.api.GameState> {
                 ...
                 */
                // @ts-ignore
                public static readonly CONSTRUCTION: org.spongepowered.api.GameState
                /**
                 * Plugins are able to access a default logger instance and access
                 * configuration files.
                 */
                // @ts-ignore
                public static readonly PRE_INITIALIZATION: org.spongepowered.api.GameState
                /**
                 * Plugins should finish any work needed to become functional. Commands
                 * should be registered at this stage.
                 */
                // @ts-ignore
                public static readonly INITIALIZATION: org.spongepowered.api.GameState
                /**
                 ...
                 */
                // @ts-ignore
                public static readonly POST_INITIALIZATION: org.spongepowered.api.GameState
                /**
                 * All plugin initialization and registration should be completed. The
                 * server is now ready to start.
                 */
                // @ts-ignore
                public static readonly LOAD_COMPLETE: org.spongepowered.api.GameState
                /**
                 * The {@link Server} instance exists, but worlds have not yet loaded.
                 */
                // @ts-ignore
                public static readonly SERVER_ABOUT_TO_START: org.spongepowered.api.GameState
                /**
                 * The server instance exists and worlds are loaded.
                 */
                // @ts-ignore
                public static readonly SERVER_STARTING: org.spongepowered.api.GameState
                /**
                 * The server is fully loaded and ready to accept clients. All worlds are
                 * loaded and all plugins have been loaded.
                 */
                // @ts-ignore
                public static readonly SERVER_STARTED: org.spongepowered.api.GameState
                /**
                 * Server is stopping for any reason. This occurs prior to world saving.
                 */
                // @ts-ignore
                public static readonly SERVER_STOPPING: org.spongepowered.api.GameState
                /**
                 * The server has stopped saving and no players are connected. Any changes
                 * to the worlds are not saved.
                 */
                // @ts-ignore
                public static readonly SERVER_STOPPED: org.spongepowered.api.GameState
                /**
                 ...
                 */
                // @ts-ignore
                public static readonly GAME_STOPPING: org.spongepowered.api.GameState
                /**
                 ...
                 */
                // @ts-ignore
                public static readonly GAME_STOPPED: org.spongepowered.api.GameState
                // @ts-ignore
                public static values(): org.spongepowered.api.GameState[]
                // @ts-ignore
                public static valueOf(name: java.lang.String | string): org.spongepowered.api.GameState
            }
        }
    }
}
