                    ...
                    namespace immutable {
                        namespace entity {
                            ...
                            interface ImmutableFallingBlockData extends org.spongepowered.api.data.manipulator.ImmutableDataManipulator<org.spongepowered.api.data.manipulator.immutable.entity.ImmutableFallingBlockData, org.spongepowered.api.data.manipulator.mutable.entity.FallingBlockData> {
                                 ...
                                 */
                                // @ts-ignore
                                fallDamagePerBlock(): org.spongepowered.api.data.value.immutable.ImmutableValue<java.lang.Double | number>
                                /**
                                 ...
                                 */
                                // @ts-ignore
                                maxFallDamage(): org.spongepowered.api.data.value.immutable.ImmutableValue<java.lang.Double | number>
                                /**
                                 ...
                                 */
                                // @ts-ignore
                                fallTime(): org.spongepowered.api.data.value.immutable.ImmutableValue<java.lang.Integer | number>
                                /**
