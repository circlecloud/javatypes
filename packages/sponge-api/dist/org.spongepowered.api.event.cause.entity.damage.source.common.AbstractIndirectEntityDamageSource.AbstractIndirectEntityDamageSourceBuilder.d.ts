                                ...
                                namespace common {
                                    namespace AbstractIndirectEntityDamageSource {
                                        ...
                                        abstract class AbstractIndirectEntityDamageSourceBuilder<T extends org.spongepowered.api.event.cause.entity.damage.source.IndirectEntityDamageSource, B extends org.spongepowered.api.event.cause.entity.damage.source.IndirectEntityDamageSource.AbstractBuilder<T, B>> extends org.spongepowered.api.event.cause.entity.damage.source.common.AbstractEntityDamageSource.AbstractEntityDamageSourceBuilder<T, B> implements org.spongepowered.api.event.cause.entity.damage.source.IndirectEntityDamageSource.AbstractBuilder<T, B> {
                                            ...
                                            // @ts-ignore
                                            public entity(entity: org.spongepowered.api.entity.Entity): B
                                            // @ts-ignore
                                            public proxySource(projectile: org.spongepowered.api.entity.Entity): B
                                            // @ts-ignore
                                            public reset(): B
                                        }
                                    }
