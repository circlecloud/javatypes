    ...
    namespace util {
        namespace concurrent {
            ...
            abstract class CountedCompleter<T> extends java.util.concurrent.ForkJoinTask<T> {
                 ...
                 */
                // @ts-ignore
                constructor(completer: java.util.concurrent.CountedCompleter<any>, initialPendingCount: number /*int*/)
                /**
                 * Creates a new CountedCompleter with the given completer
                 ...
                 */
                // @ts-ignore
                constructor(completer: java.util.concurrent.CountedCompleter<any>)
                /**
