declare namespace java {
    namespace sql {
        ...
        interface Statement extends java.sql.Wrapper, java.lang.AutoCloseable {
             ...
             */
            // @ts-ignore
            executeUpdate(sql: string, autoGeneratedKeys: number /*int*/): int
            /**
             ...
             */
            // @ts-ignore
            executeUpdate(sql: string, columnIndexes: number /*int*/[]): int
            /**
             * Executes the given SQL statement and signals the driver that the
             * auto-generated keys indicated in the given array should be made available
             ...
             */
            // @ts-ignore
            executeUpdate(sql: string, columnNames: string[]): int
            /**
             * Executes the given SQL statement, which may return multiple results,
             ...
             */
            // @ts-ignore
            execute(sql: string, autoGeneratedKeys: number /*int*/): boolean
            /**
             * Executes the given SQL statement, which may return multiple results,
             ...
             */
            // @ts-ignore
            execute(sql: string, columnIndexes: number /*int*/[]): boolean
            /**
             * Executes the given SQL statement, which may return multiple results,
             * and signals the driver that the
             * auto-generated keys indicated in the given array should be made available
             ...
             */
            // @ts-ignore
            executeLargeUpdate(sql: string, autoGeneratedKeys: number /*int*/): long
            /**
             * Executes the given SQL statement and signals the driver that the
             * auto-generated keys indicated in the given array should be made available
             * for retrieval.   This array contains the indexes of the columns in the
             ...
             */
            // @ts-ignore
            executeLargeUpdate(sql: string, columnIndexes: number /*int*/[]): long
            /**
             * Executes the given SQL statement and signals the driver that the
             * auto-generated keys indicated in the given array should be made available
             * for retrieval.   This array contains the names of the columns in the
