        ...
        namespace im {
            namespace spi {
                ...
                interface InputMethodContext extends java.awt.im.InputMethodRequests {
                     ...
                     */
                    // @ts-ignore
                    dispatchInputMethodEvent(id: number /*int*/, text: java.text.AttributedCharacterIterator, committedCharacterCount: number /*int*/, caret: java.awt.font.TextHitInfo, visiblePosition: java.awt.font.TextHitInfo): void
                    /**
