    ...
    namespace imageio {
        namespace event {
            ...
            interface IIOReadProgressListener extends java.util.EventListener {
                 ...
                 */
                // @ts-ignore
                sequenceStarted(source: javax.imageio.ImageReader, minIndex: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                sequenceComplete(source: javax.imageio.ImageReader): void
                /**
                 ...
                 */
                // @ts-ignore
                imageStarted(source: javax.imageio.ImageReader, imageIndex: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                imageProgress(source: javax.imageio.ImageReader, percentageDone: number /*float*/): void
                /**
                 ...
                 */
                // @ts-ignore
                imageComplete(source: javax.imageio.ImageReader): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailStarted(source: javax.imageio.ImageReader, imageIndex: number /*int*/, thumbnailIndex: number /*int*/): void
                /**
                 * Reports the approximate degree of completion of the current
                 ...
                 */
                // @ts-ignore
                thumbnailProgress(source: javax.imageio.ImageReader, percentageDone: number /*float*/): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailComplete(source: javax.imageio.ImageReader): void
                /**
                 ...
                 */
                // @ts-ignore
                readAborted(source: javax.imageio.ImageReader): void
            }
        }
    }
}
