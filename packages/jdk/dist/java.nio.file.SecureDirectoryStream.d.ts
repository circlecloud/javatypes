    ...
    namespace nio {
        namespace file {
            ...
            interface SecureDirectoryStream<T> extends java.nio.file.DirectoryStream<T> {
                 ...
                 */
                // @ts-ignore
                newDirectoryStream(path: T, ...options: java.nio.file.LinkOption[]): java.nio.file.SecureDirectoryStream<T>
                /**
                 ...
                 */
                // @ts-ignore
                move(srcpath: T, targetdir: java.nio.file.SecureDirectoryStream<T>, targetpath: T): void
                /**
                 ...
                 */
                // @ts-ignore
                getFileAttributeView<V extends java.nio.file.attribute.FileAttributeView>(type: java.lang.Class<V>): V
                /**
                 ...
                 */
                // @ts-ignore
                getFileAttributeView<V extends java.nio.file.attribute.FileAttributeView>(path: T, type: java.lang.Class<V>, ...options: java.nio.file.LinkOption[]): V
            }
        }
    }
}
