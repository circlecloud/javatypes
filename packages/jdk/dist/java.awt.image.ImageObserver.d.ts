    ...
    namespace awt {
        namespace image {
            ...
            interface ImageObserver {
                 ...
                 */
                // @ts-ignore
                readonly PROPERTIES: number /*int*/
                /**
                 * This flag in the infoflags argument to imageUpdate indicates that
                 ...
                 */
                // @ts-ignore
                imageUpdate(img: java.awt.Image, infoflags: number /*int*/, x: number /*int*/, y: number /*int*/, width: number /*int*/, height: number /*int*/): boolean
            }
        }
    }
}
