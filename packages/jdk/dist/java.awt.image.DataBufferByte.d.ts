    ...
    namespace awt {
        namespace image {
            ...
            class DataBufferByte extends java.awt.image.DataBuffer {
                 ...
                 */
                // @ts-ignore
                constructor(dataArray: number /*byte*/[], size: number /*int*/)
                /**
                 * Constructs a byte-based <CODE>DataBuffer</CODE> with a single bank using the
                 ...
                 */
                // @ts-ignore
                constructor(dataArray: number /*byte*/[], size: number /*int*/, offset: number /*int*/)
                /**
                 ...
                 */
                // @ts-ignore
                constructor(dataArray: number /*byte*/[][], size: number /*int*/, offsets: number /*int*/[])
                /**
                 ...
                 */
                // @ts-ignore
                public getData(bank: number /*int*/): number /*byte*/[]
                /**
                 ...
                 */
                // @ts-ignore
                public getBankData(): number /*byte*/[][]
                /**
