    ...
    namespace awt {
        namespace font {
            ...
            class GlyphMetrics extends java.lang.Object {
                 ...
                 */
                // @ts-ignore
                constructor(advance: number /*float*/, bounds: java.awt.geom.Rectangle2D, glyphType: number /*byte*/)
                /**
                 * Constructs a <code>GlyphMetrics</code> object.
                 ...
                 */
                // @ts-ignore
                constructor(horizontal: boolean, advanceX: number /*float*/, advanceY: number /*float*/, bounds: java.awt.geom.Rectangle2D, glyphType: number /*byte*/)
                /**
