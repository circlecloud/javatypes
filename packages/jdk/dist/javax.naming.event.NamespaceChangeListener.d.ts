    ...
    namespace naming {
        namespace event {
            ...
            interface NamespaceChangeListener extends javax.naming.event.NamingListener {
                 ...
                 */
                // @ts-ignore
                objectAdded(evt: javax.naming.event.NamingEvent): void
                /**
                 ...
                 */
                // @ts-ignore
                objectRemoved(evt: javax.naming.event.NamingEvent): void
                /**
                 ...
                 */
                // @ts-ignore
                objectRenamed(evt: javax.naming.event.NamingEvent): void
            }
        }
    }
}
