    ...
    namespace awt {
        namespace dnd {
            ...
            class DragSourceDragEvent extends java.awt.dnd.DragSourceEvent {
                 ...
                 */
                // @ts-ignore
                constructor(dsc: java.awt.dnd.DragSourceContext, dropAction: number /*int*/, action: number /*int*/, modifiers: number /*int*/)
                /**
                 ...
                 */
                // @ts-ignore
                constructor(dsc: java.awt.dnd.DragSourceContext, dropAction: number /*int*/, action: number /*int*/, modifiers: number /*int*/, x: number /*int*/, y: number /*int*/)
                /**
