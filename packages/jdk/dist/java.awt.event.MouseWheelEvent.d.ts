    ...
    namespace awt {
        namespace event {
            ...
            class MouseWheelEvent extends java.awt.event.MouseEvent {
                 ...
                 */
                // @ts-ignore
                constructor(source: java.awt.Component, id: number /*int*/, when: number /*long*/, modifiers: number /*int*/, x: number /*int*/, y: number /*int*/, clickCount: number /*int*/, popupTrigger: boolean, scrollType: number /*int*/, scrollAmount: number /*int*/, wheelRotation: number /*int*/)
                /**
                 * Constructs a <code>MouseWheelEvent</code> object with the
                 * specified source component, type, modifiers, coordinates,
                 ...
                 */
                // @ts-ignore
                constructor(source: java.awt.Component, id: number /*int*/, when: number /*long*/, modifiers: number /*int*/, x: number /*int*/, y: number /*int*/, xAbs: number /*int*/, yAbs: number /*int*/, clickCount: number /*int*/, popupTrigger: boolean, scrollType: number /*int*/, scrollAmount: number /*int*/, wheelRotation: number /*int*/)
                /**
                 ...
                 */
                // @ts-ignore
                constructor(source: java.awt.Component, id: number /*int*/, when: number /*long*/, modifiers: number /*int*/, x: number /*int*/, y: number /*int*/, xAbs: number /*int*/, yAbs: number /*int*/, clickCount: number /*int*/, popupTrigger: boolean, scrollType: number /*int*/, scrollAmount: number /*int*/, wheelRotation: number /*int*/, preciseWheelRotation: number /*double*/)
                /**
