    ...
    namespace imageio {
        namespace event {
            ...
            interface IIOWriteProgressListener extends java.util.EventListener {
                 ...
                 */
                // @ts-ignore
                imageStarted(source: javax.imageio.ImageWriter, imageIndex: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                imageProgress(source: javax.imageio.ImageWriter, percentageDone: number /*float*/): void
                /**
                 ...
                 */
                // @ts-ignore
                imageComplete(source: javax.imageio.ImageWriter): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailStarted(source: javax.imageio.ImageWriter, imageIndex: number /*int*/, thumbnailIndex: number /*int*/): void
                /**
                 * Reports the approximate degree of completion of the current
                 ...
                 */
                // @ts-ignore
                thumbnailProgress(source: javax.imageio.ImageWriter, percentageDone: number /*float*/): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailComplete(source: javax.imageio.ImageWriter): void
                /**
                 ...
                 */
                // @ts-ignore
                writeAborted(source: javax.imageio.ImageWriter): void
            }
        }
    }
}
