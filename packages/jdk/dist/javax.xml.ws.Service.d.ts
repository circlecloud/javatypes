    ...
    namespace xml {
        namespace ws {
            ...
            class Service extends java.lang.Object {
                // @ts-ignore
                constructor(wsdlDocumentLocation: java.net.URL, serviceName: javax.xml.namespace.QName)
                // @ts-ignore
                constructor(wsdlDocumentLocation: java.net.URL, serviceName: javax.xml.namespace.QName, ...features: javax.xml.ws.WebServiceFeature[])
                /**
