    ...
    namespace util {
        namespace stream {
            ...
            interface LongStream extends java.util.stream.BaseStream<java.lang.Long | number, java.util.stream.LongStream> {
                 ...
                 */
                // @ts-ignore
                limit(maxSize: number /*long*/): java.util.stream.LongStream
                /**
                 ...
                 */
                // @ts-ignore
                skip(n: number /*long*/): java.util.stream.LongStream
                /**
                 ...
                 */
                // @ts-ignore
                of(t: number /*long*/): java.util.stream.LongStream
                /**
                 ...
                 */
                // @ts-ignore
                of(...values: number /*long*/[]): java.util.stream.LongStream
                /**
                 ...
                 */
                // @ts-ignore
                range(startInclusive: number /*long*/, endExclusive: number /*long*/): java.util.stream.LongStream
                /**
                 * Returns a sequential ordered {@code LongStream} from {@code startInclusive}
                 ...
                 */
                // @ts-ignore
                rangeClosed(startInclusive: number /*long*/, endInclusive: number /*long*/): java.util.stream.LongStream
                /**
