    ...
    namespace awt {
        namespace image {
            ...
            abstract class PackedColorModel extends java.awt.image.ColorModel {
                 ...
                 */
                // @ts-ignore
                constructor(space: java.awt.color.ColorSpace, bits: number /*int*/, colorMaskArray: number /*int*/[], alphaMask: number /*int*/, isAlphaPremultiplied: boolean, trans: number /*int*/, transferType: number /*int*/)
                /**
                 ...
                 */
                // @ts-ignore
                constructor(space: java.awt.color.ColorSpace, bits: number /*int*/, rmask: number /*int*/, gmask: number /*int*/, bmask: number /*int*/, amask: number /*int*/, isAlphaPremultiplied: boolean, trans: number /*int*/, transferType: number /*int*/)
                /**
