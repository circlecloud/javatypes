    ...
    namespace time {
        namespace temporal {
            ...
            interface Temporal extends java.time.temporal.TemporalAccessor {
                 ...
                 */
                // @ts-ignore
                with(field: java.time.temporal.TemporalField, newValue: number /*long*/): java.time.temporal.Temporal
                /**
                 ...
                 */
                // @ts-ignore
                plus(amountToAdd: number /*long*/, unit: java.time.temporal.TemporalUnit): java.time.temporal.Temporal
                /**
                 ...
                 */
                // @ts-ignore
                minus(amountToSubtract: number /*long*/, unit: java.time.temporal.TemporalUnit): java.time.temporal.Temporal
                /**
