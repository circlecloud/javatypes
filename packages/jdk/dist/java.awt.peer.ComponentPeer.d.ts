    ...
    namespace awt {
        namespace peer {
            ...
            interface ComponentPeer {
                 ...
                 */
                // @ts-ignore
                setBounds(x: number /*int*/, y: number /*int*/, width: number /*int*/, height: number /*int*/, op: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                requestFocus(lightweightChild: java.awt.Component, temporary: boolean, focusedWindowChangeAllowed: boolean, time: number /*long*/, cause: sun.awt.CausedFocusEvent.Cause): boolean
                /**
                 ...
                 */
                // @ts-ignore
                prepareImage(img: java.awt.Image, w: number /*int*/, h: number /*int*/, o: java.awt.image.ImageObserver): boolean
                /**
                 ...
                 */
                // @ts-ignore
                flip(x1: number /*int*/, y1: number /*int*/, x2: number /*int*/, y2: number /*int*/, flipAction: java.awt.BufferCapabilities.FlipContents): void
                /**
                 ...
                 */
                // @ts-ignore
                applyShape(shape: sun.java2d.pipe.Region): void
                /**
