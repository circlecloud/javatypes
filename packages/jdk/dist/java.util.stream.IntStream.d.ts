    ...
    namespace util {
        namespace stream {
            ...
            interface IntStream extends java.util.stream.BaseStream<java.lang.Integer, java.util.stream.IntStream> {
                 ...
                 */
                // @ts-ignore
                limit(maxSize: number /*long*/): java.util.stream.IntStream
                /**
                 ...
                 */
                // @ts-ignore
                skip(n: number /*long*/): java.util.stream.IntStream
                /**
                 ...
                 */
                // @ts-ignore
                of(t: number /*int*/): java.util.stream.IntStream
                /**
                 ...
                 */
                // @ts-ignore
                of(...values: number /*int*/[]): java.util.stream.IntStream
                /**
                 ...
                 */
                // @ts-ignore
                range(startInclusive: number /*int*/, endExclusive: number /*int*/): java.util.stream.IntStream
                /**
                 * Returns a sequential ordered {@code IntStream} from {@code startInclusive}
                 ...
                 */
                // @ts-ignore
                rangeClosed(startInclusive: number /*int*/, endInclusive: number /*int*/): java.util.stream.IntStream
                /**
