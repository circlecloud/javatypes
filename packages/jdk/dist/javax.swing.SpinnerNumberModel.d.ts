declare namespace javax {
    namespace swing {
        ...
        class SpinnerNumberModel extends javax.swing.AbstractSpinnerModel implements java.io.Serializable {
             ...
             */
            // @ts-ignore
            constructor(value: number /*int*/, minimum: number /*int*/, maximum: number /*int*/, stepSize: number /*int*/)
            /**
             * Constructs a <code>SpinnerNumberModel</code> with the specified
             * <code>value</code>, <code>minimum</code>/<code>maximum</code> bounds,
             * and <code>stepSize</code>.
             ...
             */
            // @ts-ignore
            constructor(value: number /*double*/, minimum: number /*double*/, maximum: number /*double*/, stepSize: number /*double*/)
            /**
