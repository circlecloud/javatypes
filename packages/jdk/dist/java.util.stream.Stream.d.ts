    ...
    namespace util {
        namespace stream {
            ...
            interface Stream<T> extends java.util.stream.BaseStream<T, java.util.stream.Stream<T>> {
                 ...
                 */
                // @ts-ignore
                limit(maxSize: number /*long*/): java.util.stream.Stream<T>
                /**
                 ...
                 */
                // @ts-ignore
                skip(n: number /*long*/): java.util.stream.Stream<T>
                /**
                 ...
                 */
                // @ts-ignore
                of<T>(t: T): java.util.stream.Stream<T>
                /**
                 ...
                 */
                // @ts-ignore
                of<T>(...values: T[]): java.util.stream.Stream<T>
                /**
