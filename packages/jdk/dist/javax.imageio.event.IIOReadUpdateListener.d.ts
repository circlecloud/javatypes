    ...
    namespace imageio {
        namespace event {
            ...
            interface IIOReadUpdateListener extends java.util.EventListener {
                 ...
                 */
                // @ts-ignore
                passStarted(source: javax.imageio.ImageReader, theImage: java.awt.image.BufferedImage, pass: number /*int*/, minPass: number /*int*/, maxPass: number /*int*/, minX: number /*int*/, minY: number /*int*/, periodX: number /*int*/, periodY: number /*int*/, bands: number /*int*/[]): void
                /**
                 ...
                 */
                // @ts-ignore
                imageUpdate(source: javax.imageio.ImageReader, theImage: java.awt.image.BufferedImage, minX: number /*int*/, minY: number /*int*/, width: number /*int*/, height: number /*int*/, periodX: number /*int*/, periodY: number /*int*/, bands: number /*int*/[]): void
                /**
                 ...
                 */
                // @ts-ignore
                passComplete(source: javax.imageio.ImageReader, theImage: java.awt.image.BufferedImage): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailPassStarted(source: javax.imageio.ImageReader, theThumbnail: java.awt.image.BufferedImage, pass: number /*int*/, minPass: number /*int*/, maxPass: number /*int*/, minX: number /*int*/, minY: number /*int*/, periodX: number /*int*/, periodY: number /*int*/, bands: number /*int*/[]): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailUpdate(source: javax.imageio.ImageReader, theThumbnail: java.awt.image.BufferedImage, minX: number /*int*/, minY: number /*int*/, width: number /*int*/, height: number /*int*/, periodX: number /*int*/, periodY: number /*int*/, bands: number /*int*/[]): void
                /**
                 ...
                 */
                // @ts-ignore
                thumbnailPassComplete(source: javax.imageio.ImageReader, theThumbnail: java.awt.image.BufferedImage): void
            }
        }
    }
}
