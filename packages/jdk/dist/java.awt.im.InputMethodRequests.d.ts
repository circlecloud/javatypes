    ...
    namespace awt {
        namespace im {
            ...
            interface InputMethodRequests {
                 ...
                 */
                // @ts-ignore
                getLocationOffset(x: number /*int*/, y: number /*int*/): java.awt.font.TextHitInfo
                /**
                 ...
                 */
                // @ts-ignore
                getCommittedText(beginIndex: number /*int*/, endIndex: number /*int*/, attributes: java.text.AttributedCharacterIterator.Attribute[]): java.text.AttributedCharacterIterator
                /**
