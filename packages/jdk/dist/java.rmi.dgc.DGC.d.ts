    ...
    namespace rmi {
        namespace dgc {
            ...
            interface DGC extends java.rmi.Remote {
                 ...
                 */
                // @ts-ignore
                dirty(ids: java.rmi.server.ObjID[], sequenceNum: number /*long*/, lease: java.rmi.dgc.Lease): java.rmi.dgc.Lease
                /**
                 ...
                 */
                // @ts-ignore
                clean(ids: java.rmi.server.ObjID[], sequenceNum: number /*long*/, vmid: java.rmi.dgc.VMID, strong: boolean): void
            }
        }
    }
}
