declare namespace java {
    namespace sql {
        ...
        interface Connection extends java.sql.Wrapper, java.lang.AutoCloseable {
             ...
             */
            // @ts-ignore
            createStatement(resultSetType: number /*int*/, resultSetConcurrency: number /*int*/): java.sql.Statement
            /**
             ...
             */
            // @ts-ignore
            setHoldability(holdability: number /*int*/): void
            /**
             ...
             */
            // @ts-ignore
            createStatement(resultSetType: number /*int*/, resultSetConcurrency: number /*int*/, resultSetHoldability: number /*int*/): java.sql.Statement
            /**
             * Creates a <code>PreparedStatement</code> object that will generate
             * <code>ResultSet</code> objects with the given type, concurrency,
             * and holdability.
             ...
             */
            // @ts-ignore
            isValid(timeout: number /*int*/): boolean
            /**
             ...
             */
            // @ts-ignore
            setNetworkTimeout(executor: java.util.concurrent.Executor, milliseconds: number /*int*/): void
            /**
