        ...
        namespace plaf {
            namespace multi {
                ...
                class MultiTextUI extends javax.swing.plaf.TextUI {
                     ...
                     */
                    // @ts-ignore
                    getToolTipText(a: javax.swing.text.JTextComponent, b: java.awt.Point): java.lang.String
                    /**
                     ...
                     */
                    // @ts-ignore
                    modelToView(a: javax.swing.text.JTextComponent, b: number /*int*/): java.awt.Rectangle
                    /**
                     * Invokes the <code>modelToView</code> method on each UI handled by this object.
                     * @return the value obtained from the first UI, which is
                     *  the UI obtained from the default <code>LookAndFeel</code>
                     */
                    // @ts-ignore
                    modelToView(a: javax.swing.text.JTextComponent, b: number /*int*/, c: javax.swing.text.Position.Bias): java.awt.Rectangle
                    /**
                     ...
                     */
                    // @ts-ignore
                    viewToModel(a: javax.swing.text.JTextComponent, b: java.awt.Point): int
                    /**
                     * Invokes the <code>viewToModel</code> method on each UI handled by this object.
                     * @return the value obtained from the first UI, which is
                     *  the UI obtained from the default <code>LookAndFeel</code>
                     */
                    // @ts-ignore
                    viewToModel(a: javax.swing.text.JTextComponent, b: java.awt.Point, c: javax.swing.text.Position.Bias[]): int
                    /**
                     ...
                     */
                    // @ts-ignore
                    getNextVisualPositionFrom(a: javax.swing.text.JTextComponent, b: number /*int*/, c: javax.swing.text.Position.Bias, d: number /*int*/, e: javax.swing.text.Position.Bias[]): int
                    /**
                     * Invokes the <code>damageRange</code> method on each UI handled by this object.
                     */
                    // @ts-ignore
                    damageRange(a: javax.swing.text.JTextComponent, b: number /*int*/, c: number /*int*/): void
                    /**
                     * Invokes the <code>damageRange</code> method on each UI handled by this object.
                     */
                    // @ts-ignore
                    damageRange(a: javax.swing.text.JTextComponent, b: number /*int*/, c: number /*int*/, d: javax.swing.text.Position.Bias, e: javax.swing.text.Position.Bias): void
                    /**
                     ...
                     */
                    // @ts-ignore
                    getEditorKit(a: javax.swing.text.JTextComponent): javax.swing.text.EditorKit
                    /**
                     ...
                     */
                    // @ts-ignore
                    getRootView(a: javax.swing.text.JTextComponent): javax.swing.text.View
                    /**
