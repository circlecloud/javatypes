    ...
    namespace sql {
        namespace rowset {
            ...
            interface Joinable {
                 ...
                 */
                // @ts-ignore
                setMatchColumn(columnIdx: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                setMatchColumn(columnIdxes: number /*int*/[]): void
                /**
                 * Sets the designated column as the match column for this <code>RowSet</code>
                 * object. A <code>JoinRowSet</code> object can now add this <code>RowSet</code>
                 * object based on the match column.
                 ...
                 */
                // @ts-ignore
                unsetMatchColumn(columnIdx: number /*int*/): void
                /**
                 ...
                 */
                // @ts-ignore
                unsetMatchColumn(columnIdxes: number /*int*/[]): void
                /**
                 * Unsets the designated column as the match column for this <code>RowSet</code>
                 * object.
                 * <P>
