    ...
    namespace springframework {
        namespace util {
            namespace ConcurrentReferenceHashMap {
                 ...
                 */
                // @ts-ignore
                class ReferenceManager extends java.lang.Object {
                    // @ts-ignore
                    constructor()
                    /**
                     ...
                     */
                    // @ts-ignore
                    public createReference(entry: org.springframework.util.ConcurrentReferenceHashMap.Entry<K, V>, hash: number /*int*/, next: org.springframework.util.ConcurrentReferenceHashMap.Reference<K, V>): org.springframework.util.ConcurrentReferenceHashMap.Reference<K, V>
                    /**
                     ...
                     */
                    // @ts-ignore
                    public pollForPurge(): org.springframework.util.ConcurrentReferenceHashMap.Reference<K, V>
                }
            }
        }
    }
