        ...
        namespace data {
            namespace mongodb {
                namespace core {
                     ...
                     */
                    // @ts-ignore
                    interface ReactiveMapReduceOperation {
                        /**
                         ...
                         */
                        // @ts-ignore
                        mapReduce<T>(domainType: java.lang.Class<T>): org.springframework.data.mongodb.core.ReactiveMapReduceOperation.MapReduceWithMapFunction<T>
                    }
                }
            }
        }
