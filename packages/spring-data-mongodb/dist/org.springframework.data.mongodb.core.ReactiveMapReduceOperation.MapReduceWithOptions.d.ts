                ...
                namespace core {
                    namespace ReactiveMapReduceOperation {
                        ...
                        interface MapReduceWithOptions<T> {
                             ...
                             */
                            // @ts-ignore
                            with(options: org.springframework.data.mongodb.core.mapreduce.MapReduceOptions): org.springframework.data.mongodb.core.ReactiveMapReduceOperation.ReactiveMapReduce<T>
                        }
                    }
                }
            }
