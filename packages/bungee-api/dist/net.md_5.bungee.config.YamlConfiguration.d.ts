        ...
        namespace bungee {
            namespace config {
                ...
                class YamlConfiguration extends net.md_5.bungee.config.ConfigurationProvider {
                    ...
                    // @ts-ignore
                    public load(jis: java.io.InputStream): net.md_5.bungee.config.Configuration
                    // @ts-ignore
                    public load(jis: java.io.InputStream, defaults: net.md_5.bungee.config.Configuration): net.md_5.bungee.config.Configuration
                    // @ts-ignore
                    public load(string: java.lang.String | string): net.md_5.bungee.config.Configuration
                    // @ts-ignore
                    public load(string: java.lang.String | string, defaults: net.md_5.bungee.config.Configuration): net.md_5.bungee.config.Configuration
                }
            }
        }
    }
