        ...
        namespace bungee {
            namespace api {
                namespace event {
                     ...
                     */
                    // @ts-ignore
                    class LoginEvent extends net.md_5.bungee.api.event.AsyncEvent<net.md_5.bungee.api.event.LoginEvent> implements net.md_5.bungee.api.plugin.Cancellable {
                        // @ts-ignore
                        constructor(connection: net.md_5.bungee.api.connection.PendingConnection, done: net.md_5.bungee.api.Callback<net.md_5.bungee.api.event.LoginEvent>)
                        /**
