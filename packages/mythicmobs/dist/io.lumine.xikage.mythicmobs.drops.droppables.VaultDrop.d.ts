            ...
            namespace mythicmobs {
                namespace drops {
                    namespace droppables {
                        // @ts-ignore
                        class VaultDrop extends io.lumine.xikage.mythicmobs.drops.Drop implements io.lumine.xikage.mythicmobs.drops.IIntangibleDrop, io.lumine.xikage.mythicmobs.drops.IMessagingDrop {
                            // @ts-ignore
