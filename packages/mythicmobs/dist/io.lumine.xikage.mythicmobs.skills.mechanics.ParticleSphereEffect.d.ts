        ...
        namespace xikage {
            namespace mythicmobs {
                namespace skills {
                    namespace mechanics {
                        // @ts-ignore
                        class ParticleSphereEffect extends io.lumine.xikage.mythicmobs.skills.mechanics.ParticleEffect implements io.lumine.xikage.mythicmobs.skills.ITargetedEntitySkill, io.lumine.xikage.mythicmobs.skills.ITargetedLocationSkill {
                            // @ts-ignore
                            ...
                            // @ts-ignore
                            playParticleSphereEffect(data: io.lumine.xikage.mythicmobs.skills.SkillMetadata, t: io.lumine.xikage.mythicmobs.adapters.AbstractLocation): void
                            // @ts-ignore
