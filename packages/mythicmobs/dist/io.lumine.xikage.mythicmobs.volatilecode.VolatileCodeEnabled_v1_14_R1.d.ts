        ...
        namespace xikage {
            namespace mythicmobs {
                namespace volatilecode {
                    // @ts-ignore
                    class VolatileCodeEnabled_v1_14_R1 extends java.lang.Object implements io.lumine.xikage.mythicmobs.volatilecode.VolatileCodeHandler {
                        // @ts-ignore
                        constructor()
                        // @ts-ignore
                        ...
                        // @ts-ignore
                        public getItemAttributeList(nms: net.minecraft.server.v1_14_R1.ItemStack): NBTTagList
                        // @ts-ignore
