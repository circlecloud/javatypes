        ...
        namespace xikage {
            namespace mythicmobs {
                namespace compatibility {
                    // @ts-ignore
                    class HolographicDisplaysSupport extends java.lang.Object implements io.lumine.xikage.mythicmobs.holograms.HologramProvider {
                        // @ts-ignore
                        constructor(mm: io.lumine.xikage.mythicmobs.MythicMobs)
                        // @ts-ignore
                        public cleanup(): void
                        // @ts-ignore
