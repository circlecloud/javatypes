        ...
        namespace xikage {
            namespace mythicmobs {
                namespace volatilecode {
                    // @ts-ignore
                    class VolatileCodeEnabled_v1_12_R1 extends java.lang.Object implements io.lumine.xikage.mythicmobs.volatilecode.VolatileCodeHandler {
                        // @ts-ignore
                        constructor()
                        // @ts-ignore
                        ...
                        // @ts-ignore
                        public CreateFireworksExplosion(loc: Location, flicker: boolean, trail: boolean, type: number /*int*/, colors: number /*int*/[], fadeColors: number /*int*/[], flightDuration: number /*int*/): void
                        // @ts-ignore
