        ...
        namespace xikage {
            namespace mythicmobs {
                namespace skills {
                    namespace mechanics {
                        // @ts-ignore
                        class HealMechanic extends io.lumine.xikage.mythicmobs.skills.SkillMechanic implements io.lumine.xikage.mythicmobs.skills.ITargetedEntitySkill {
                            // @ts-ignore
                            ...
                            overheal: boolean
                            // @ts-ignore
                            maxOverheal: io.lumine.xikage.mythicmobs.skills.placeholders.parsers.PlaceholderDouble
                            // @ts-ignore
