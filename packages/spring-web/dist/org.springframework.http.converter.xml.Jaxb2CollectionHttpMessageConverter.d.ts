            ...
            namespace converter {
                namespace xml {
                    ...
                    class Jaxb2CollectionHttpMessageConverter<T extends java.util.Collection> extends org.springframework.http.converter.xml.AbstractJaxb2HttpMessageConverter<T> implements org.springframework.http.converter.GenericHttpMessageConverter<T> {
                        ...
                        // @ts-ignore
                        readFromSource(clazz: java.lang.Class<any>, headers: org.springframework.http.HttpHeaders, source: javax.xml.transform.Source): T
                        // @ts-ignore
                        public read(type: java.lang.reflect.Type, contextClass: java.lang.Class<any>, inputMessage: org.springframework.http.HttpInputMessage): T
                        /**
                        ...
                        // @ts-ignore
                        writeToResult(t: T, headers: org.springframework.http.HttpHeaders, result: javax.xml.transform.Result): void
                        /**
