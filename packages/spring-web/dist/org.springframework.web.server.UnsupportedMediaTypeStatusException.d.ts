        ...
        namespace web {
            namespace server {
                ...
                class UnsupportedMediaTypeStatusException extends org.springframework.web.server.ResponseStatusException {
                     ...
                     */
                    // @ts-ignore
                    constructor(contentType: org.springframework.http.MediaType, supportedTypes: java.util.List<org.springframework.http.MediaType> | Array<org.springframework.http.MediaType>)
                    /**
                     * Constructor for when trying to encode from or decode to a specific Java type.
                     * @since 5.1
                     */
                    // @ts-ignore
                    constructor(contentType: org.springframework.http.MediaType, supportedTypes: java.util.List<org.springframework.http.MediaType> | Array<org.springframework.http.MediaType>, bodyType: ResolvableType)
                    /**
                     ...
                     */
                    // @ts-ignore
                    public getBodyType(): ResolvableType
                }
            }
        }
    }
