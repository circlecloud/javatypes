            ...
            namespace server {
                namespace PathContainer {
                    ...
                    class Options extends java.lang.Object {
                         ...
                         */
                        // @ts-ignore
                        public static readonly HTTP_PATH: org.springframework.http.server.PathContainer.Options
                        /**
                         ...
                         */
                        // @ts-ignore
                        public static readonly MESSAGE_ROUTE: org.springframework.http.server.PathContainer.Options
                        // @ts-ignore
                        public separator(): string
                        // @ts-ignore
                        public shouldDecodeAndParseSegments(): boolean
                        /**
                         ...
                         */
                        // @ts-ignore
                        public static create(separator: string, decodeAndParseSegments: boolean): org.springframework.http.server.PathContainer.Options
                    }
                }
            }
        }
